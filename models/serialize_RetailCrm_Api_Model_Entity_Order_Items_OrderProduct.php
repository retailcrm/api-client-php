...
function serialize_RetailCrm_Api_Model_Entity_Order_Items_OrderProduct(RetailCrm\Api\Model\Entity\Order\Items\OrderProduct $model, bool $useStdClass = true)
{
