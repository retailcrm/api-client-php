...
function deserialize_RetailCrm_Api_Model_Entity_Orders_Delivery_DeliveryData(array $jsonData): RetailCrm\Api\Model\Entity\Orders\Delivery\DeliveryData
{
    
$model = new RetailCrm\Api\Model\Entity\Orders\Delivery\DeliveryData();
...
$model->packages[$index21] = new RetailCrm\Api\Model\Entity\Orders\Delivery\Package();
...
$model->packages[$index21]->items[$index40] = new RetailCrm\Api\Model\Entity\Orders\Delivery\PackageItem();
if (isset($jsonData['packages'][$index21]['items'][$index40]['orderProduct'])) {
    
$model->packages[$index21]->items[$index40]->orderProduct = new RetailCrm\Api\Model\Entity\Orders\Delivery\PackageItemOrderProduct();
