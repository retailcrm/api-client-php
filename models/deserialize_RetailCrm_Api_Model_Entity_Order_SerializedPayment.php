...
function deserialize_RetailCrm_Api_Model_Entity_Order_SerializedPayment(array $jsonData): RetailCrm\Api\Model\Entity\Order\SerializedPayment
{
    
$model = new RetailCrm\Api\Model\Entity\Order\SerializedPayment();
