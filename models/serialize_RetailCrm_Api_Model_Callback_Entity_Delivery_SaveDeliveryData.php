...
function serialize_RetailCrm_Api_Model_Callback_Entity_Delivery_SaveDeliveryData(RetailCrm\Api\Model\Callback\Entity\Delivery\SaveDeliveryData $model, bool $useStdClass = true)
{
...
if (null !== $model->codPaymentType) {
    $jsonData["codPaymentType"] = [];
if (null !== $model->codPaymentType->code) {
    $jsonData["codPaymentType"]["code"] = $model->codPaymentType->code;
}
if (null !== $model->codPaymentType->name) {
    $jsonData["codPaymentType"]["name"] = $model->codPaymentType->name;
}

if (0 === \count($jsonData["codPaymentType"])) {
    $jsonData["codPaymentType"] = $emptyObject;
}

}
if (null !== $model->withCod) {
    $jsonData["withCod"] = $model->withCod;
}
if (null !== $model->cod) {
