...
function deserialize_RetailCrm_Api_Model_Entity_Packs_OrderProductPackHistory(array $jsonData): RetailCrm\Api\Model\Entity\Packs\OrderProductPackHistory
{
    
$model = new RetailCrm\Api\Model\Entity\Packs\OrderProductPackHistory();
