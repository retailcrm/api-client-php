...
function deserialize_RetailCrm_Api_Model_Entity_Order_Delivery_SerializedOrderDelivery(array $jsonData): RetailCrm\Api\Model\Entity\Order\Delivery\SerializedOrderDelivery
{
    
$model = new RetailCrm\Api\Model\Entity\Order\Delivery\SerializedOrderDelivery();
...
$model->data = new RetailCrm\Api\Model\Entity\Order\Delivery\DeliveryData();
...
$model->data->packages[$index29] = new RetailCrm\Api\Model\Entity\Order\Delivery\Package();
...
$model->data->packages[$index29]->items[$index48] = new RetailCrm\Api\Model\Entity\Order\Delivery\PackageItem();
if (isset($jsonData['data']['packages'][$index29]['items'][$index48]['orderProduct'])) {
    
$model->data->packages[$index29]->items[$index48]->orderProduct = new RetailCrm\Api\Model\Entity\Order\Delivery\PackageItemOrderProduct();
...
$model->data->phone = new RetailCrm\Api\Model\Entity\Order\Delivery\CourierPhone();
...
$model->service = new RetailCrm\Api\Model\Entity\Order\Delivery\SerializedDeliveryService();
