...
function serialize_RetailCrm_Api_Model_Entity_References_PaymentType(RetailCrm\Api\Model\Entity\References\PaymentType $model, bool $useStdClass = true)
{
...
foreach (array_keys($model->paymentStatuses) as $index19) {
    $jsonData["paymentStatuses"] = $model->paymentStatuses;
}
