...
function deserialize_RetailCrm_Api_Model_Entity_Store_PriceUploadInput(array $jsonData): RetailCrm\Api\Model\Entity\Store\PriceUploadInput
{
    
$model = new RetailCrm\Api\Model\Entity\Store\PriceUploadInput();
...
$model->prices[$index19] = new RetailCrm\Api\Model\Entity\Store\PriceUploadPricesInput();
