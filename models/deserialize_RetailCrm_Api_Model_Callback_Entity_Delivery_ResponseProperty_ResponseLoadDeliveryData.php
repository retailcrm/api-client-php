...
function deserialize_RetailCrm_Api_Model_Callback_Entity_Delivery_ResponseProperty_ResponseLoadDeliveryData(array $jsonData): RetailCrm\Api\Model\Callback\Entity\Delivery\ResponseProperty\ResponseLoadDeliveryData
{
    
$model = new RetailCrm\Api\Model\Callback\Entity\Delivery\ResponseProperty\ResponseLoadDeliveryData();
...
$model->status = new RetailCrm\Api\Model\Entity\Delivery\StatusInfo();
if (isset($jsonData['status']['code'])) {
    $model->status->code = $jsonData['status']['code'];

}
if (isset($jsonData['status']['updatedAt'])) {
    $model->status->updatedAt = \DateTime::createFromFormat('Y-m-d\TH:i:sP', $jsonData['status']['updatedAt']);

}
if (isset($jsonData['status']['comment'])) {
    $model->status->comment = $jsonData['status']['comment'];
