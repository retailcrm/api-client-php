...
function deserialize_RetailCrm_Api_Model_Entity_References_LegalEntity(array $jsonData): RetailCrm\Api\Model\Entity\References\LegalEntity
{
    
$model = new RetailCrm\Api\Model\Entity\References\LegalEntity();
