...
function deserialize_RetailCrm_Api_Model_Entity_Order_SerializedOrderLink(array $jsonData): RetailCrm\Api\Model\Entity\Order\SerializedOrderLink
{
    
$model = new RetailCrm\Api\Model\Entity\Order\SerializedOrderLink();
