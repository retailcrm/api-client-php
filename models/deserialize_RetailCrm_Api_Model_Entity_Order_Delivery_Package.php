...
function deserialize_RetailCrm_Api_Model_Entity_Order_Delivery_Package(array $jsonData): RetailCrm\Api\Model\Entity\Order\Delivery\Package
{
    
$model = new RetailCrm\Api\Model\Entity\Order\Delivery\Package();
...
$model->items[$index18] = new RetailCrm\Api\Model\Entity\Order\Delivery\PackageItem();
if (isset($jsonData['items'][$index18]['orderProduct'])) {
    
$model->items[$index18]->orderProduct = new RetailCrm\Api\Model\Entity\Order\Delivery\PackageItemOrderProduct();
