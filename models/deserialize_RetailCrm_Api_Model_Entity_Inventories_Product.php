...
function deserialize_RetailCrm_Api_Model_Entity_Inventories_Product(array $jsonData): RetailCrm\Api\Model\Entity\Inventories\Product
{
    
$model = new RetailCrm\Api\Model\Entity\Inventories\Product();
...
$model->offers[$index19] = new RetailCrm\Api\Model\Entity\Inventories\ProductOffer();
...
$model->offers[$index19]->prices[$index39] = new RetailCrm\Api\Model\Entity\Inventories\OfferPrice();
