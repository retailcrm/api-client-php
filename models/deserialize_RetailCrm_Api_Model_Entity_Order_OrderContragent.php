...
function deserialize_RetailCrm_Api_Model_Entity_Order_OrderContragent(array $jsonData): RetailCrm\Api\Model\Entity\Order\OrderContragent
{
    
$model = new RetailCrm\Api\Model\Entity\Order\OrderContragent();
