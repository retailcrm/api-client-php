...
function deserialize_RetailCrm_Api_Model_Entity_Order_SerializedRelationCustomer(array $jsonData): RetailCrm\Api\Model\Entity\Order\SerializedRelationCustomer
{
    
$model = new RetailCrm\Api\Model\Entity\Order\SerializedRelationCustomer();
