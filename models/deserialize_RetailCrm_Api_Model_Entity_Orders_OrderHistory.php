...
function deserialize_RetailCrm_Api_Model_Entity_Orders_OrderHistory(array $jsonData): RetailCrm\Api\Model\Entity\Orders\OrderHistory
{
    
$model = new RetailCrm\Api\Model\Entity\Orders\OrderHistory();
...
$model->ancestor = new RetailCrm\Api\Model\Entity\Orders\Order();
...
$model->ancestor->contragent = new RetailCrm\Api\Model\Entity\Orders\OrderContragent();
...
$model->ancestor->delivery = new RetailCrm\Api\Model\Entity\Orders\Delivery\SerializedOrderDelivery();
...
$model->ancestor->delivery->data = new RetailCrm\Api\Model\Entity\Orders\Delivery\DeliveryData();
...
$model->ancestor->delivery->data->packages[$index53] = new RetailCrm\Api\Model\Entity\Orders\Delivery\Package();
...
$model->ancestor->delivery->data->packages[$index53]->items[$index72] = new RetailCrm\Api\Model\Entity\Orders\Delivery\PackageItem();
if (isset($jsonData['ancestor']['delivery']['data']['packages'][$index53]['items'][$index72]['orderProduct'])) {
    
$model->ancestor->delivery->data->packages[$index53]->items[$index72]->orderProduct = new RetailCrm\Api\Model\Entity\Orders\Delivery\PackageItemOrderProduct();
...
$model->ancestor->delivery->data->phone = new RetailCrm\Api\Model\Entity\Orders\Delivery\CourierPhone();
...
$model->ancestor->delivery->service = new RetailCrm\Api\Model\Entity\Orders\Delivery\SerializedDeliveryService();
...
$model->ancestor->delivery->address = new RetailCrm\Api\Model\Entity\Orders\Delivery\OrderDeliveryAddress();
...
$model->ancestor->marketplace = new RetailCrm\Api\Model\Entity\Orders\MarketplaceData();
...
$model->ancestor->items[$index30] = new RetailCrm\Api\Model\Entity\Orders\Items\OrderProduct();
...
$model->ancestor->items[$index30]->priceType = new RetailCrm\Api\Model\Entity\Orders\Items\PriceType();
...
$model->ancestor->items[$index30]->prices[$index50] = new RetailCrm\Api\Model\Entity\Orders\Items\OrderProductPriceItem();
...
$model->ancestor->items[$index30]->offer = new RetailCrm\Api\Model\Entity\Orders\Items\Offer();
...
$model->ancestor->items[$index30]->offer->unit = new RetailCrm\Api\Model\Entity\Orders\Items\Unit();
...
if (isset($jsonData['ancestor']['items'][$index30]['order'])) {
    
$model->ancestor->items[$index30]->order = new RetailCrm\Api\Model\Entity\IdModel();
if (isset($jsonData['ancestor']['items'][$index30]['order']['id'])) {
    $model->ancestor->items[$index30]->order->id = $jsonData['ancestor']['items'][$index30]['order']['id'];
...
$model->ancestor->items[$index30]->properties[$index54] = new RetailCrm\Api\Model\Entity\Orders\Items\ItemProperty();
...
$model->ancestor->payments[$index33] = new RetailCrm\Api\Model\Entity\Orders\Payment();
...
$model->payment = new RetailCrm\Api\Model\Entity\Orders\Payment();
...
$model->combinedTo = new RetailCrm\Api\Model\Entity\Orders\Order();
...
$model->combinedTo->contragent = new RetailCrm\Api\Model\Entity\Orders\OrderContragent();
...
$model->combinedTo->delivery = new RetailCrm\Api\Model\Entity\Orders\Delivery\SerializedOrderDelivery();
...
$model->combinedTo->delivery->data = new RetailCrm\Api\Model\Entity\Orders\Delivery\DeliveryData();
...
$model->combinedTo->delivery->data->packages[$index55] = new RetailCrm\Api\Model\Entity\Orders\Delivery\Package();
...
$model->combinedTo->delivery->data->packages[$index55]->items[$index74] = new RetailCrm\Api\Model\Entity\Orders\Delivery\PackageItem();
if (isset($jsonData['combinedTo']['delivery']['data']['packages'][$index55]['items'][$index74]['orderProduct'])) {
    
$model->combinedTo->delivery->data->packages[$index55]->items[$index74]->orderProduct = new RetailCrm\Api\Model\Entity\Orders\Delivery\PackageItemOrderProduct();
...
$model->combinedTo->delivery->data->phone = new RetailCrm\Api\Model\Entity\Orders\Delivery\CourierPhone();
...
$model->combinedTo->delivery->service = new RetailCrm\Api\Model\Entity\Orders\Delivery\SerializedDeliveryService();
...
$model->combinedTo->delivery->address = new RetailCrm\Api\Model\Entity\Orders\Delivery\OrderDeliveryAddress();
...
$model->combinedTo->marketplace = new RetailCrm\Api\Model\Entity\Orders\MarketplaceData();
...
$model->combinedTo->items[$index32] = new RetailCrm\Api\Model\Entity\Orders\Items\OrderProduct();
...
$model->combinedTo->items[$index32]->priceType = new RetailCrm\Api\Model\Entity\Orders\Items\PriceType();
...
$model->combinedTo->items[$index32]->prices[$index52] = new RetailCrm\Api\Model\Entity\Orders\Items\OrderProductPriceItem();
...
$model->combinedTo->items[$index32]->offer = new RetailCrm\Api\Model\Entity\Orders\Items\Offer();
...
$model->combinedTo->items[$index32]->offer->unit = new RetailCrm\Api\Model\Entity\Orders\Items\Unit();
...
if (isset($jsonData['combinedTo']['items'][$index32]['order'])) {
    
$model->combinedTo->items[$index32]->order = new RetailCrm\Api\Model\Entity\IdModel();
if (isset($jsonData['combinedTo']['items'][$index32]['order']['id'])) {
    $model->combinedTo->items[$index32]->order->id = $jsonData['combinedTo']['items'][$index32]['order']['id'];
...
$model->combinedTo->items[$index32]->properties[$index56] = new RetailCrm\Api\Model\Entity\Orders\Items\ItemProperty();
...
$model->combinedTo->payments[$index35] = new RetailCrm\Api\Model\Entity\Orders\Payment();
