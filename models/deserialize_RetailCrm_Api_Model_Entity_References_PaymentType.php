...
function deserialize_RetailCrm_Api_Model_Entity_References_PaymentType(array $jsonData): RetailCrm\Api\Model\Entity\References\PaymentType
{
    
$model = new RetailCrm\Api\Model\Entity\References\PaymentType();
...
foreach (array_keys($jsonData['paymentStatuses']) as $index28) {
    $model->paymentStatuses[$index28] = $jsonData['paymentStatuses'][$index28];
