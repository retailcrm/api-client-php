...
function deserialize_RetailCrm_Api_Model_Entity_Orders_SerializedRelationCustomer(array $jsonData): RetailCrm\Api\Model\Entity\Orders\SerializedRelationCustomer
{
    
$model = new RetailCrm\Api\Model\Entity\Orders\SerializedRelationCustomer();
