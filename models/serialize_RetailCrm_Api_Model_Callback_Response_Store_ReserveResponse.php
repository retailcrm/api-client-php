...
function serialize_RetailCrm_Api_Model_Callback_Response_Store_ReserveResponse(RetailCrm\Api\Model\Callback\Response\Store\ReserveResponse $model, bool $useStdClass = true)
{
...
foreach (array_keys($model->inventories[$index15]->offers[$index35]->stores) as $index55) {
    $jsonData["inventories"][$index15]["offers"][$index35]["stores"][$index55] = [];
if (null !== $model->inventories[$index15]->offers[$index35]->stores[$index55]->quantity) {
    $jsonData["inventories"][$index15]["offers"][$index35]["stores"][$index55]["quantity"] = $model->inventories[$index15]->offers[$index35]->stores[$index55]->quantity;
}
if (null !== $model->inventories[$index15]->offers[$index35]->stores[$index55]->purchasePrice) {
    $jsonData["inventories"][$index15]["offers"][$index35]["stores"][$index55]["purchasePrice"] = $model->inventories[$index15]->offers[$index35]->stores[$index55]->purchasePrice;
}
if (null !== $model->inventories[$index15]->offers[$index35]->stores[$index55]->store) {
    $jsonData["inventories"][$index15]["offers"][$index35]["stores"][$index55]["store"] = $model->inventories[$index15]->offers[$index35]->stores[$index55]->store;
}
if (null !== $model->inventories[$index15]->offers[$index35]->stores[$index55]->code) {
    $jsonData["inventories"][$index15]["offers"][$index35]["stores"][$index55]["code"] = $model->inventories[$index15]->offers[$index35]->stores[$index55]->code;
}
if (null !== $model->inventories[$index15]->offers[$index35]->stores[$index55]->available) {
    $jsonData["inventories"][$index15]["offers"][$index35]["stores"][$index55]["available"] = $model->inventories[$index15]->offers[$index35]->stores[$index55]->available;
}

if (0 === \count($jsonData["inventories"][$index15]["offers"][$index35]["stores"][$index55])) {
    $jsonData["inventories"][$index15]["offers"][$index35]["stores"][$index55] = $emptyObject;
}
