...
function deserialize_RetailCrm_Api_Model_Callback_Entity_Inventories_PackItemModel(array $jsonData): RetailCrm\Api\Model\Callback\Entity\Inventories\PackItemModel
{
    
$model = new RetailCrm\Api\Model\Callback\Entity\Inventories\PackItemModel();
