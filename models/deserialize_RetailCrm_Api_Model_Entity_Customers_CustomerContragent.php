...
function deserialize_RetailCrm_Api_Model_Entity_Customers_CustomerContragent(array $jsonData): RetailCrm\Api\Model\Entity\Customers\CustomerContragent
{
    
$model = new RetailCrm\Api\Model\Entity\Customers\CustomerContragent();
