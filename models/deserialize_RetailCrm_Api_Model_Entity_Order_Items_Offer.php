...
function deserialize_RetailCrm_Api_Model_Entity_Order_Items_Offer(array $jsonData): RetailCrm\Api\Model\Entity\Order\Items\Offer
{
    
$model = new RetailCrm\Api\Model\Entity\Order\Items\Offer();
...
$model->unit = new RetailCrm\Api\Model\Entity\Order\Items\Unit();
