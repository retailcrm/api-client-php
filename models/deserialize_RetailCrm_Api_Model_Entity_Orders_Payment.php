...
function deserialize_RetailCrm_Api_Model_Entity_Orders_Payment(array $jsonData): RetailCrm\Api\Model\Entity\Orders\Payment
{
    
$model = new RetailCrm\Api\Model\Entity\Orders\Payment();
