...
function deserialize_RetailCrm_Api_Model_Response_Store_ProductGroupsResponse(array $jsonData): RetailCrm\Api\Model\Response\Store\ProductGroupsResponse
{
    
$model = new RetailCrm\Api\Model\Response\Store\ProductGroupsResponse();
...
$model->productGroup[$index25] = new RetailCrm\Api\Model\Entity\Store\ProductGroup();
