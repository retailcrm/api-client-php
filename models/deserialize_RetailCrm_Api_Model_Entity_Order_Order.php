...
function deserialize_RetailCrm_Api_Model_Entity_Order_Order(array $jsonData): RetailCrm\Api\Model\Entity\Order\Order
{
    
$model = new RetailCrm\Api\Model\Entity\Order\Order();
...
$model->contragent = new RetailCrm\Api\Model\Entity\Order\OrderContragent();
...
$model->delivery = new RetailCrm\Api\Model\Entity\Order\Delivery\SerializedOrderDelivery();
...
$model->delivery->data = new RetailCrm\Api\Model\Entity\Order\Delivery\DeliveryData();
...
$model->delivery->data->packages[$index41] = new RetailCrm\Api\Model\Entity\Order\Delivery\Package();
...
$model->delivery->data->packages[$index41]->items[$index60] = new RetailCrm\Api\Model\Entity\Order\Delivery\PackageItem();
if (isset($jsonData['delivery']['data']['packages'][$index41]['items'][$index60]['orderProduct'])) {
    
$model->delivery->data->packages[$index41]->items[$index60]->orderProduct = new RetailCrm\Api\Model\Entity\Order\Delivery\PackageItemOrderProduct();
...
$model->delivery->data->phone = new RetailCrm\Api\Model\Entity\Order\Delivery\CourierPhone();
...
$model->delivery->service = new RetailCrm\Api\Model\Entity\Order\Delivery\SerializedDeliveryService();
...
$model->marketplace = new RetailCrm\Api\Model\Entity\Order\MarketplaceData();
...
$model->items[$index18] = new RetailCrm\Api\Model\Entity\Order\Items\OrderProduct();
...
$model->items[$index18]->priceType = new RetailCrm\Api\Model\Entity\Order\Items\PriceType();
...
$model->items[$index18]->prices[$index38] = new RetailCrm\Api\Model\Entity\Order\Items\OrderProductPriceItem();
...
$model->items[$index18]->offer = new RetailCrm\Api\Model\Entity\Order\Items\Offer();
...
$model->items[$index18]->offer->unit = new RetailCrm\Api\Model\Entity\Order\Items\Unit();
...
$model->items[$index18]->properties[$index42] = new RetailCrm\Api\Model\Entity\Order\Items\ItemProperty();
...
$model->payments[$index21] = new RetailCrm\Api\Model\Entity\Order\Payment();
