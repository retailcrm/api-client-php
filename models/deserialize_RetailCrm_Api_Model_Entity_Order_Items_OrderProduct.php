...
function deserialize_RetailCrm_Api_Model_Entity_Order_Items_OrderProduct(array $jsonData): RetailCrm\Api\Model\Entity\Order\Items\OrderProduct
{
    
$model = new RetailCrm\Api\Model\Entity\Order\Items\OrderProduct();
...
$model->priceType = new RetailCrm\Api\Model\Entity\Order\Items\PriceType();
...
$model->prices[$index19] = new RetailCrm\Api\Model\Entity\Order\Items\OrderProductPriceItem();
...
$model->offer = new RetailCrm\Api\Model\Entity\Order\Items\Offer();
...
$model->offer->unit = new RetailCrm\Api\Model\Entity\Order\Items\Unit();
...
$model->properties[$index23] = new RetailCrm\Api\Model\Entity\Order\Items\ItemProperty();
