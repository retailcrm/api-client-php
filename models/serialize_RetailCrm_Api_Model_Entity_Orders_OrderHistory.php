...
function serialize_RetailCrm_Api_Model_Entity_Orders_OrderHistory(RetailCrm\Api\Model\Entity\Orders\OrderHistory $model, bool $useStdClass = true)
{
...
if (null !== $model->ancestor->items[$index21]->order) {
    $jsonData["ancestor"]["items"][$index21]["order"] = [];
if (null !== $model->ancestor->items[$index21]->order->id) {
    $jsonData["ancestor"]["items"][$index21]["order"]["id"] = $model->ancestor->items[$index21]->order->id;
}

if (0 === \count($jsonData["ancestor"]["items"][$index21]["order"])) {
    $jsonData["ancestor"]["items"][$index21]["order"] = $emptyObject;
}
...
if (null !== $model->combinedTo->items[$index23]->order) {
    $jsonData["combinedTo"]["items"][$index23]["order"] = [];
if (null !== $model->combinedTo->items[$index23]->order->id) {
    $jsonData["combinedTo"]["items"][$index23]["order"]["id"] = $model->combinedTo->items[$index23]->order->id;
}

if (0 === \count($jsonData["combinedTo"]["items"][$index23]["order"])) {
    $jsonData["combinedTo"]["items"][$index23]["order"] = $emptyObject;
}
