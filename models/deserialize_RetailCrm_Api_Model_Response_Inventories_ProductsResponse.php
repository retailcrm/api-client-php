...
function deserialize_RetailCrm_Api_Model_Response_Inventories_ProductsResponse(array $jsonData): RetailCrm\Api\Model\Response\Inventories\ProductsResponse
{
    
$model = new RetailCrm\Api\Model\Response\Inventories\ProductsResponse();
...
$model->products[$index21] = new RetailCrm\Api\Model\Entity\Inventories\Product();
...
$model->products[$index21]->offers[$index41] = new RetailCrm\Api\Model\Entity\Inventories\ProductOffer();
...
$model->products[$index21]->offers[$index41]->prices[$index61] = new RetailCrm\Api\Model\Entity\Inventories\OfferPrice();
