...
class Order
{
    ...
    /**
     * @var \RetailCrm\Api\Interfaces\Order\CustomerInterface
     *
     * @JMS\Type("RetailCrm\Api\Interfaces\Order\CustomerInterface")
    ...
    /**
     * @var \RetailCrm\Api\Model\Entity\Order\OrderContragent
     *
     * @JMS\Type("RetailCrm\Api\Model\Entity\Order\OrderContragent")
     * @JMS\SerializedName("contragent")
     */
    public $contragent;

    /**
     * @var \RetailCrm\Api\Model\Entity\Order\Delivery\SerializedOrderDelivery
     *
     * @JMS\Type("RetailCrm\Api\Model\Entity\Order\Delivery\SerializedOrderDelivery")
     * @JMS\SerializedName("delivery")
     */
    public $delivery;

    /**
     * @var \RetailCrm\Api\Model\Entity\Order\MarketplaceData
     *
     * @JMS\Type("RetailCrm\Api\Model\Entity\Order\MarketplaceData")
     ...
     *
     * @JMS\Type("array<RetailCrm\Api\Model\Entity\Order\Items\OrderProduct>")
     ...
     *
     * @JMS\Type("array<RetailCrm\Api\Model\Entity\Order\Payment>")
