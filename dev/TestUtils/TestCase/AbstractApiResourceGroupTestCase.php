 ...
 * @package  RetailCrm\Dev\TestUtils\TestCase
 */

namespace RetailCrm\Dev\TestUtils\TestCase;
...
use RetailCrm\Dev\TestUtils\Exception\MatcherException;
use RetailCrm\Dev\TestUtils\RequestMatcher;
...
abstract class AbstractApiResourceGroupTestCase extends TestCase
{
     ...
     * @param string $path
     *
     * @return \RetailCrm\Dev\TestUtils\Exception\RequestMatcher
     */
